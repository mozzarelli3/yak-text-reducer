      ...
      <div className="min-h-screen overflow-hidden">
        <div className="interface">
          <div className="min-h-screen flex flex-col md:flex-row">
            ...
            {/* --- Left Sidebar --- */}
            <div className="w-full md:w-1/4 border-r h-screen overflow-y-auto scrollbar-thin hidden md:block">
            ...
            {/* --- Right Content Area --- */}
            <div className="w-full md:w-3/4 bg-offwhite shadow-md relative overflow-y-auto">
              ...
              <div className="flex flex-col space-y-10 w-full p-4">
                <div className="bg-yakyellow h-24 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl shadow-md p-4 w-full md:w-2/3 ml-auto"></div>
                <div className="bg-white h-24 rounded-tl-2xl rounded-tr-2xl rounded-br-2xl shadow-md p-4 w-full md:w-1/2"></div>
                <div className="bg-yakyellow h-24 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl shadow-md p-4 w-full md:w-1/2 ml-auto"></div>
                <div className="bg-white h-24 rounded-tl-2xl rounded-tr-2xl rounded-br-2xl shadow-md p-4 w-full md:w-2/3"></div>
              </div>
